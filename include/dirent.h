...
static int dirent_mbstowcs_s(size_t *pReturnValue, wchar_t *wcstr, size_t sizeInWords,
                             const char *mbstr, size_t count);

static int dirent_wcstombs_s(size_t *pReturnValue, char *mbstr, size_t sizeInBytes,
                ...
                if (dirp->patt) {
                        ...
                        if (n > 0) {
                                ...
                                if (dirp->patt < p) {
                                        ...
                                        case '/':
                                        case ':':
                                            /* Directory ends in path separator, e.g.
                                               c:\temp\ */
                                            /*NOP*/;
                                                break;
...
readdir_r(DIR *dirp, struct dirent *entry, struct dirent **result)
{
        ...
        if (datap) {
                ...
                if (error && datap->cAlternateFileName[0] != '\0') {
                        error =
                            dirent_wcstombs_s(&n, entry->d_name, PATH_MAX + 1,
        ...
        int (*compare)(const struct dirent **, const struct dirent **))
{
        ...
        if (dir) {
                ...
                while (1) {
                        ...
                        if (tmp == NULL) {
                                tmp = malloc(sizeof(struct dirent));
                                if (tmp == NULL) {
                                        result = -1;
                                        break;
                                }
                        ...
                        if (readdir_r(dir, tmp, &entry) == /*OK*/ 0) {
                                ...
                                if (entry != NULL) {
                                        ...
                                        /* Determine whether to include the entry in
                                         * result */
                                        if (filter) {
                                        ...
                                        /*
                                         * End of directory stream reached => sort entries * and exit.
                                         */
...
static int
dirent_mbstowcs_s(size_t *pReturnValue, wchar_t *wcstr, size_t sizeInWords,
                  const char *mbstr, size_t count)
{
        int error;
